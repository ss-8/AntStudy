...
<body>
	<div id="detailInfo" class="container-fluid">
		<div class="row-fluid" style="margin-top: 10px">
			<div class="col-md-12">
				<video id="movies" controls width="100%" height="400"
					...
					<source src="<%=basePath%>video/dress_0.mp4" type="video/mp4">
		...
		<div class="row-fluid">
			<div class="col-md-6">
				<canvas id="myCanvas" width="417px" height="545px" style="float: right;"></canvas>
			</div>
			<div class="col-md-6">
	...
	<script type="text/javascript">
		...
		var videoRatio=(500/video.videoWidth).toFixed(2);
		video.addEventListener('play', function(){
			videoRatio=(500/video.videoWidth).toFixed(2);
